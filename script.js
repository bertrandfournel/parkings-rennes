window.onload = () => {
    ...
    const urlParcRelais = "https://data.rennesmetropole.fr/api/records/1.0/search/?dataset=etat-des-parcs-relais-du-reseau-star-en-temps-reel&sort=idparc&facet=nom&facet=etat"       
